...
- (void)viewDidLoad
{
	...
	self.crystallBall = [[KPMagicBall alloc] init];
	
//	UIImage *backgroundImage = [UIImage imageNamed:@"background"];
//	UIImageView *imageView = [[UIImageView alloc] initWithImage:backgroundImage];
//	[self.view insertSubview:imageView atIndex:0];
	
	self.bacgroundImageView.animationImages = [[NSArray alloc] initWithObjects:
	...
	self.bacgroundImageView.animationDuration = 2.0f;
	self.bacgroundImageView.animationRepeatCount = 1;
}
...
//	self.predictionLabel.frame = CGRectMake(20, 50, frame.size.width, frame.size.height);
...
-(void)makePrediction
{
	[self.bacgroundImageView startAnimating];
